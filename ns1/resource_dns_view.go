...
func dnsView() *schema.Resource {
	s := map[string]*schema.Schema{
		"name": {
			...
			Required:   true,
			Deprecated: "ns1_dnsview is deprecated and will be removed in a future release. The underlying API endpoint has been removed.",
		},
		"created_at": {
			Type:       schema.TypeInt,
			Computed:   true,
	...
	return &schema.Resource{
		...
		SchemaVersion:      1,
		DeprecationMessage: "ns1_dnsview is deprecated and will be removed in a future release. The underlying API endpoint has been removed.",
	}
}
